...
from odd.datasets import DATASETS as DATASETS
...
@patch('odd.datasets.MOTChallengeDataset.load_annotations', MagicMock)
@patch('odd.datasets.MOTChallengeDataset._filter_imgs', MagicMock)
@pytest.mark.parametrize('dataset', ['MOTChallengeDataset'])
