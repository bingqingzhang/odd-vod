...
from odd.apis import init_random_seed
from odd.core import setup_multi_processes
from odd.datasets import build_dataset
from odd.utils import collect_env, get_root_logger
...
def main():
    ...
    if cfg.get('USE_MMDET', False):
        ...
        from odd.models import build_reid as build_model
        if 'reid' in cfg.model:
            cfg.model = cfg.model.reid
    else:
        from odd.apis import train_model
    ...
    if cfg.checkpoint_config is not None:
        # save odd version, config file content and class names in
